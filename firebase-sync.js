...
import { getFirestore, doc, setDoc, onSnapshot } from "https://www.gstatic.com/firebasejs/10.14.0/firebase-firestore.js";
...
const keysToSync = ['clarity_yearly_goals', 'clarity_monthly_goals', 'clarity_weekly_goals', 'clarity_daily_tasks', 'clarity_reflections', 'clarity_dismissed_notifications', 'clarity_habits'];
